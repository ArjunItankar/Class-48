...
textSize(20);
  fill("blue")
text("Bullets = " + bullets,displayWdith-210,displayHeight/2-250);
text("Score = " + score,displayWdith-200,displayHeight/2-220);
text("Lives = " + life,displayWdith-200,displayHeight/2-280);
